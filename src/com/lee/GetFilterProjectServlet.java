...
// * 
// */
//@WebServlet(urlPatterns = { "/get_filter_project" })
//public class GetFilterProjectServlet extends HttpServlet {
//	private static final long serialVersionUID = 1L;
//
//	public GetFilterProjectServlet() {
//		super();
//	}
//
...
//		
//		System.err.println("getallproject flag " + flag+" category:"+category +" industry:"+industry+" projectstage:"+projectstage+
//				"financestage:"+financestage+" financescale:"+financescale+" mode:"+mode);
//
...
////		getIndustry(projectSimpleList);
////		getCategory(projectSimpleList);
//		info.mProjectSimpleList = projectSimpleList;
//
...
////		for (int j = 0; j < 10; j++) {
//			for (int i = 0; i < Money_Scale.length; i++) {
//				ProjcetSimpleInfo simple = new ProjcetSimpleInfo();
//				simple.projectId = "1045";
//				simple.projectName = "项目" + i;
//				simple.projectCategory = "国内一级";
//				simple.financeScale = Money_Scale[i];
//				simple.createUserLevel = "1";
//				simple.createuUsergGender = "男";
//				simple.createUserId = "452";
//				simple.createUserRealName = "周杰伦";
//				if (i == 1) {
//					simple.createUserCommentName = "备注姓名";
//				}
//				simple.createUserCity = "广州";
//				simple.createUserPortrait = "http://133.130.102.178:8080/jiuyou/liutao.jpg";
...
//	}
//
//	private void getIndustry(List<ProjcetSimpleInfo> projectSimpleList) {
//		for (int j = 0; j < 10; j++) {
//			for (int i = 0; i < Industry_Indicator.length; i++) {
//				ProjcetSimpleInfo simple = new ProjcetSimpleInfo();
//				simple.projectId = "1045";
//				simple.projectName = "项目" + i;
//				simple.projectCategory = "国内一级";
//				simple.financeScale =Money_Scale[2];
//				simple.industry = Industry_Indicator[i];
//				simple.createUserLevel = "1";
//				simple.createuUsergGender = "男";
//				simple.createUserId = "452";
//				simple.createUserRealName = "周杰伦";
...
//	}
//	
//	private void getCategory(List<ProjcetSimpleInfo> projectSimpleList) {
//		for (int j = 0; j < 10; j++) {
//			for (int i = 0; i < Category_Indicator.length; i++) {
//				ProjcetSimpleInfo simple = new ProjcetSimpleInfo();
//				simple.projectId = "1045";
//				simple.projectName = "项目" + i;
//				simple.projectCategory = Category_Indicator[i];
//				simple.industry = Industry_Indicator[2];
//				simple.financeScale = Money_Scale[2];
//				simple.createUserLevel = "1";
//				simple.createuUsergGender = "男";
//				simple.createUserId = "452";
