 ...
 * 
 */
@WebServlet(urlPatterns = { "/getuser_projectinfo" })
public class getuser_projectinfo extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public getuser_projectinfo() {
		super();
	}
	...
	private void getScale(List<ProjcetSimpleInfo> projectSimpleList) {
		for (int j = 0; j < Money_Scale.length; j++) {
				...
				simple.createuserlevel = AllUserInfo.LiuDeHua.level;
				simple.createusergender = AllUserInfo.LiuDeHua.gender;
				simple.createuserid = AllUserInfo.LiuDeHua.userid;
				simple.createuserrealname = AllUserInfo.LiuDeHua.realname;
				simple.createusercity = AllUserInfo.LiuDeHua.city;
				simple.createuserportrait =  AllUserInfo.LiuDeHua.portrait;
